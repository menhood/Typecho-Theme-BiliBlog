...
class Smilies_Plugin implements Typecho_Plugin_Interface
{
	...
	public static function activate()
	{
		...
		Typecho_Plugin::factory('Widget_Archive')->indexHandle = array('Smilies_Plugin','showsmilies');
...
<?php
	...
	public static function output($widget='')
	{
		...
		$smiliesdisplay = $settings->allowpop
			 ? ' style="display:none;position:;z-index:9999;width:'.$width.'px;margin-top:-70px;padding:5px;background-color:#fff;border:1px solid '.$bcolor.';'.$radius.$shadow.'"'
			 : ' style="display:block;"';
